...
<tr>
<td align="center">
	<h2 align="center"><font face="TAHOMA" color="RED ">BADMINTON PRODUCT ENTRY</font></h2>
	
			<form action="savebadmintonitem.php" method="post" enctype="multipart/form-data">
			...
			<?php
				...
				<tr>
					...
					<option>Badminton Cock</option>
					<option>Racket weight</option>
					<option>Grips</option>
					<option>Racket</option>
					<option>Grip Powder</option>
