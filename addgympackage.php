...
<tr>
<td align="center">
	<h2 align="center"><font face="TAHOMA" color="RED ">GYM PACKAGE ENTRY</font></h2>
	
			<form action="savegympackage.php" method="post" enctype="multipart/form-data">
				<table align="center" width="500"  HEIGHT="400">
				<tr>
					<td align="right">Package Id
			<?php
						
							$sql="select count(*) as Records from gympackages";
